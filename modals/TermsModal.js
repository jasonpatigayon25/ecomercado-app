      ...
      <Modal visible={isVisible} animationType="slide" transparent={true}>
        <View style={styles.container}>
          <ScrollView>
            ...
            <Text style={styles.header}>Condition of Donated Items:</Text>
            <Text style={styles.paragraph}>●	Donated items must be in a condition that is usable, similar to new, or as good as new.</Text>
            ...
            <Text style={styles.header}>Limitation on Donation Transactions:</Text>
            <Text style={styles.paragraph}>●	Users are limited to a maximum of 2 donation transactions per week per user account.</Text>
            <Text style={styles.paragraph}>●	This limitation is set to ensure fairness and to manage the influx of items efficiently.</Text>

            <Text style={styles.header}>Weight Limitations:</Text>
            ...
            <Text style={styles.header}>Heavy Items and Furniture:</Text>
            ...
            <Text style={styles.paragraph}>● 2-5 kg: 50 pesos</Text>
            <Text style={styles.paragraph}>● 5-10 kg: 100 pesos</Text>
            <Text style={styles.paragraph}>● 10-15 kg: 150 pesos</Text>
            <Text style={styles.paragraph}>● 10-20 kg: 200 - 250 pesos</Text>
            <Text style={styles.paragraph}>● 20-30 kg: 300 - 350 pesos</Text>
            <Text style={styles.paragraph}>● 30-40 kg: 400 - 450 pesos</Text>
            <Text style={styles.paragraph}>● Above 40 kg: 500 pesos</Text>

            <Text style={styles.header}>Donation Size-Based Fee:</Text>
            <Text style={styles.paragraph}>
              ● Small (e.g., chairs, small tables): 
              Fee based on weight (2-5 kg: 50 pesos, 5-10 kg: 100 pesos)
            </Text>
            <Text style={styles.paragraph}>
              ● Medium (e.g., armchairs, desks): 
              Fee slightly higher than small items due to size and handling complexity
            </Text>
            <Text style={styles.paragraph}>
              ● Large (e.g., sofas, large cabinets): 
              Fee adjusted for significant size and handling requirements
            </Text>
            <Text style={styles.paragraph}>
              ● Extra Large (e.g., wardrobes, pianos): 
              Highest fee tier, reflecting the substantial size and complexity of handling
            </Text>
            ...
            <Text style={styles.header}>EcoMercado Selling Terms and Conditions</Text>
            ...
            <Text style={styles.header}>Item Condition:</Text>
            ...
            <Text style={styles.header}>Listing and Pricing:</Text>
            ...
            <Text style={styles.header}>Returns and Disputes:</Text>
