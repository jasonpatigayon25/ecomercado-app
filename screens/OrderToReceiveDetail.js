...
const OrderToReceiveDetails = ({ route, navigation }) => {
  ...
  const confirmReceipt = async () => {
    ...
    try {
      await sendPushNotification(userEmail, 'Order Received', buyerNotificationMessage, 'OrderHistory');
      await sendPushNotification(order.sellerEmail, 'Order Received', sellerNotificationMessage, 'SellerOrderManagement');
    } catch (error) {
