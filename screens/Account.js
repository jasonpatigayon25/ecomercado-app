      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.settingsContainer}>
          <TouchableOpacity style={styles.settingItem} onPress={() => navigation.navigate('AboutUs')}>
            <Icon name="info-circle" size={25} color="#05652D" style={styles.settingIcon} />
          ...
          <TouchableOpacity style={styles.settingItem} onPress={() => navigation.navigate('ContactUs')}>
            <Icon name="envelope" size={25} color="#05652D" style={styles.settingIcon} />
            <Text style={styles.settingLabel}>Contact Us</Text>
            <Icon name="angle-right" size={25} color="#05652D" style={styles.settingArrowIcon} />
          </TouchableOpacity>
          <TouchableOpacity style={styles.settingItem} onPress={() => navigation.navigate('NotificationSettings')}>
            <Icon name="bell" size={25} color="#05652D" style={styles.settingIcon} />
