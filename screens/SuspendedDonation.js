...
const SuspendedDonation = ({ navigation }) => {
  ...
  const fetchDonationItems = async (email) => {
    ...
    try {
      ...
      querySnapshot.forEach((doc) => {
        ...
        if (donationData.publicationStatus === 'declined') {
          donationItems.push({ id: doc.id, ...donationData });
        }
      });
        ...
        <View style={styles.modalOverlay}>
          <ScrollView style={styles.editModalContainer}>
            ...
            <TouchableOpacity
                ...
                onPress={() => {
                    navigation.navigate('ResubmitDonation', { donationInfo: item });
                    onClose();  
                }}
                >
...
export default SuspendedDonation;