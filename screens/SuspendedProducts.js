...
const SuspendedProducts = ({ navigation }) => {
...
const showOptions = (item, event) => {
  ...
  const renderEmptyProducts = () => {
    if (products.filter(product => product.publicationStatus === 'declined').length === 0) {
      return (
        <View style={styles.emptyProductsContainer}>
          <Icon name="ban" size={50} color="#ccc" />
          <Text style={styles.emptyProductsText}>No Suspended Products Yet</Text>
        </View>
      );
    }
    return null;
  ...
  >
    <View style={styles.productItemContainer}>
      ...
      {item.publicationStatus === 'declined' && (
        <View style={styles.statusIconContainer}>
          <Icon name="ban" size={14} color="red" />
        ...
        <View style={styles.modalOverlay}>
          <ScrollView style={styles.editModalContainer}>
            ...
            <TouchableOpacity
                ...
                onPress={() => {
                    navigation.navigate('ResubmitProduct', { productInfo: product });
                    onClose();  
                }}
                >
              <Text style={styles.modalButtonText}>RESUBMIT</Text>
            </TouchableOpacity>
          </ScrollView>
        </View>
      </Modal>
        ...
        <View style={styles.modalOverlay}>
          <ScrollView style={styles.editModalContainer}>
            ...
            <TouchableOpacity style={styles.savebutton} onPress={handleSave}>
              <Text style={styles.savebuttonText}>Resubmit Product</Text>
            </TouchableOpacity>
  ...
  />
  <FlatList
      data={products.filter(product => product.publicationStatus === 'declined')}
