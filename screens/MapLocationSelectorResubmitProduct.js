...
const MapLocationSelectorResubmitProduct = () => {
    ...
    const confirmLocation = () => {
        if (selectedLocation) {
            navigation.navigate('ResubmitProduct', { location: selectedLocation });
        } else {
...
export default MapLocationSelectorResubmitProduct;