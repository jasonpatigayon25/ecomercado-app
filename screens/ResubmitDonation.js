...
const ResubmitDonation = ({ route, navigation }) => {
  ...
  const handleSubmit = async () => {
    ...
    const donationRef = doc(db, 'donation', donationInfo.id);
  ...
  return (
    ...
    <Modal
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Resubmit Donation</Text>
      </View>
      ...
      <Text style={styles.label}>
        ...
        <TouchableOpacity style={[styles.input, missingFields.location && styles.missingField]} onPress={() => navigation.navigate('MapLocationSelectorResubmitDonation')}>
