...
const MapLocationSelectorDonateAddDonation = () => {
    ...
    const confirmLocation = () => {
        if (selectedLocation) {
            navigation.navigate('DonateAddDonation', { location: selectedLocation });
        } else {
...
export default MapLocationSelectorDonateAddDonation;