...
const MapLocationSelectorResubmitDonation = () => {
    ...
    const confirmLocation = () => {
        if (selectedLocation) {
            navigation.navigate('ResubmitDonation', { location: selectedLocation });
        } else {
...
export default MapLocationSelectorResubmitDonation;